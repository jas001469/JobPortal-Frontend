    ...
    if (!loading && window.location.hash) {
      ...
      if (element) {
        ...
        setTimeout(() => {
          ...
          // Add highlight class
          element.classList.add('ring-4', 'ring-red-200', 'transition-all', 'duration-1000');
          // Remove highlight after 2 seconds
          setTimeout(() => {
            element.classList.remove('ring-4', 'ring-red-200');
    ...
    <div className="min-h-screen bg-gray-50 pt-24 pb-12">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          {/* Resume Link */}
          <div id="resume-section" className="bg-white rounded-2xl shadow-lg p-8 scroll-mt-24">
            <h2 className="text-xl font-bold text-gray-900 mb-6">Resume</h2>
            ...
            <div className="border-2 border-gray-300 rounded-2xl p-8">
              {resumeLink ? (
                <div className="mb-6">
                  <div className="flex items-center justify-between bg-gray-50 rounded-xl p-4">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="font-medium text-gray-900">Current Resume</span>
                    </div>
                    <a
                      href={resumeLink}
                      target="_blank"
                ...
                <div className="mb-6 text-center">
                  ...
                  <p className="text-gray-700 mb-2">No resume added</p>
                  <p className="text-sm text-gray-500">
                    Add a link to your online resume below
                  </p>
                </div>
              )}
