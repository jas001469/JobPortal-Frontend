...
// // Interface for Plan (matching the subscription page)
// interface Plan {
//   _id: string;
//   name: string;
//   type: string;
...
//         if (SUBSCRIPTION_CONFIG.ENABLED) {
//           // Fetch all employer plans first (just like subscription page)
//           const plansResponse = await fetch(
//             `${process.env.NEXT_PUBLIC_API_URL}/plans/type/employer`,
//             {
//               credentials: "include",
//             }
//           );
...
//               console.log("Fetched plans:", plansData.plans);
//             }
//           }
...
//               // Find the matching plan from plans array (just like in subscription page)
//               const matchedPlan = plans.find(
//                 (plan) => plan.name === subData.subscription.plan.name
//               );
...
//     // Simple check: jobsPosted < plan.jobPostings
//     return jobsPosted < currentPlan.perks.jobPostings;
//   };
...
//     return Math.max(0, currentPlan.perks.jobPostings - jobsPosted);
//   };
...
//         {SUBSCRIPTION_CONFIG.ENABLED && subscription?.status === "active" && currentPlan && (
//           <div className="mb-6 bg-gradient-to-r from-red-700 to-red-800 rounded-2xl shadow-lg p-6 text-white">
//             <div className="flex flex-col md:flex-row justify-between items-center">
//               <div className="flex items-center mb-4 md:mb-0">
//                 <Crown className="h-8 w-8 mr-4" />
...
//                   <h2 className="text-xl font-bold">{subscription.plan.name} Plan</h2>
//                   <p className="text-red-100">
//                     {remainingJobs} job postings remaining • {currentPlan.perks.featuredJobs} featured jobs
//                   </p>
//                 </div>
//               </div>
//               <div className="flex space-x-4">
//                 <div className="bg-white bg-opacity-20 rounded-lg px-4 py-2 text-center">
//                   <p className="text-xs text-red-100">Posted</p>
//                   <p className="text-2xl font-bold">{jobsPosted}/{currentPlan.perks.jobPostings}</p>
//                 </div>
//                 <button
//                   onClick={() => router.push("/subscription")}
//                   className="bg-white text-red-700 px-4 py-2 rounded-lg font-medium hover:bg-gray-100 transition"
...
//           {SUBSCRIPTION_CONFIG.ENABLED && currentPlan && (
//             <div className="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-xl">
//               <h3 className="font-semibold text-blue-900 mb-2 flex items-center">
//                 <CheckCircle className="h-4 w-4 mr-2" />
//                 Your Plan Benefits
...
//                 <div className="flex items-center text-blue-800">
//                   <Briefcase className="h-4 w-4 mr-2" />
//                   {currentPlan.perks.jobPostings} Job Postings
//                 </div>
//                 <div className="flex items-center text-blue-800">
//                   <Star className="h-4 w-4 mr-2" />
//                   {currentPlan.perks.featuredJobs} Featured Jobs
//                 </div>
//                 <div className="flex items-center text-blue-800">
//                   <Calendar className="h-4 w-4 mr-2" />
//                   Jobs displayed for {currentPlan.perks.jobDisplayDays} days
//                 </div>
//               </div>
//             </div>
//           )}
