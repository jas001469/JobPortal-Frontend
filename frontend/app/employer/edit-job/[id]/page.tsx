...
// Indian locations data (same as post job)
...
// Job categories (same as post job)
  ...
  const fetchJobDetails = async () => {
    try {
      ...
      if (data.success && data.job) {
        ...
        // Check if job type is from custom options or standard
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const jobData = {
        ...
        jobReferenceLink: form.jobReferenceLink,
      };
